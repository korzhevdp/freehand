...
<body>
	...
	<style type="text/css">
		...
		#YMapsID {
			width:100%;height:800px;outline:1px solid #FFFFFF;margin:0px;padding:0;
		}
		#l_photo {
		...
		#uiFrameName {
			width: 270px; overflow:hidden; color: black; font-size: 18px; font-weight:bold; padding-top:2px;
		}
		#frameNum {
	...
	<div class="controls">
		<div class="pull-left" id="uiFrameName">&nbsp;</div>
