<tr>
	...
	<td>
		...
		<a  href="<?=$this->config->item("base_url");?>map/<?=$hash_a;?>" title="Нередактируемая карта"><?=$hash_a;?></a><br>
		<img src="<?=$this->config->item("api");?>/images/map_edit.png" width="16" height="16" border="0" alt="">
		<a  href="<?=$this->config->item("base_url");?>map/<?=$hash_e;?>" style="color:red" title="Редактируемая карта"><?=$hash_e;?></a></td>
	<td>
